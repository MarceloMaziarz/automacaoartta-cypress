...
//                         CLICA NO BOTÃO "NÃO TENHO NÚMERO" 
     ...
     clicaBotaoAdicionar(){
        ...
        obterMensagemDeSucessoSocioProcessado(){

                cy.xpath("//div[@class='Toastify__toast-container Toastify__toast-container--top-right']", { timeout: 10000 })
                 .should('be.visible')
                 .and('contain.text', 'Sócio processado com sucesso!')
                    
     }

        obterMensagemDeSucessoArquivo(){

                cy.xpath("//div[@class='Toastify__toast-container Toastify__toast-container--top-right']", { timeout: 10000 })
                 .should('be.visible')
                 .and('contain.text', 'Arquivo enviado com sucesso')
     }
    ...
    validaBotaoProximoDesabilitado(){

        cy.xpath("//button[@class='Button__StyledButton-sc-1kni2mh-0 hoHzkd']").should('be.disabled')
...
export default new SociosPagePJ()